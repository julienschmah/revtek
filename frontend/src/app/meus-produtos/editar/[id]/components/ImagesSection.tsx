  ...
  return (
    <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
        ...
        <label 
          className="border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center p-4 hover:border-amber-500 transition-colors aspect-w-1 aspect-h-1 cursor-pointer"
